...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (caloryGoal * userInfo.carbRatio / KCAL_IN_1G_CARBS).roundToInt()
        val proteinGoal = (caloryGoal * userInfo.proteinRatio / KCAL_IN_1G_PROTEIN).roundToInt()
        val fatGoal = (caloryGoal * userInfo.fatRatio / KCAL_IN_1G_FAT).roundToInt()
