...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        return UserInfo(
            gender = Gender.fromString(genderString ?: Gender.default),
            age = age,
            weight = weight,
            height = height,
            activityLevel = ActivityLevel.fromString(activityLevelString ?: ActivityLevel.default),
            goalType = GoalType.fromString(goalTypeString ?: GoalType.default),
            carbRatio = carbRatio,
